...
// Base URL for normal web (browser) build
const WEB_API_URL =
  import.meta.env.VITE_API_URL ??
  (import.meta.env.PROD ? "https://api.vitask.app" : "http://localhost:8000");

// Optional different base URL for the desktop app (Tauri)
const DESKTOP_API_URL =
  import.meta.env.VITE_DESKTOP_API_URL ??
  // fallback to same as web if not set
  WEB_API_URL;

// Final URL used by axios
const API_URL = isTauri ? DESKTOP_API_URL : WEB_API_URL;
